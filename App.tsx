...
export default function App() {
  return (
    <View style={tw`flex flex-1 py-6 items-start`}>
      <Text style={tw`mt-1 text-lg font-bold px-3`}>Variants</Text>
      ...
      <View style={tw`mt-1 flex flex-row flex-wrap gap-2 justify-center`}>
        ...
        <IconButton variant="warning" icon={<AntDesign name="home" size={20} color={"#fff"} />} />
        <IconButton variant="destructive" icon={<AntDesign name="home" size={20} color={"#fff"} />} />
      ...
      <View style={tw`mt-1 flex flex-row flex-wrap gap-2 justify-center`}>
        ...
        <IconButton loading variant="warning" icon={<AntDesign name="home" size={20} color={"#fff"} />} />
        <IconButton loading variant="destructive" icon={<AntDesign name="home" size={20} color={"#fff"} />} />
